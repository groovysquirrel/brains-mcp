...
/**
 * Transformer for converting ITRG-BRA object to CSV format
 */
export const itrg_bra_objectToCsvTransformer: Transformer = {
  config: {
    name: 'itrg-bra-object-to-csv',
    description: 'Converts ITRG-BRA object to CSV format',
    version: '1.0.0',
    objectType: 'itrg-bra',
    fromView: 'object',
    toView: 'csv'
